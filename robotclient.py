...
def start_Robot(brew_type):
 ...
 #   robotScript = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
   # robotScript.connect((HOST, PORT2))
    ...
    data2 = robot2.recv(1024)
    print ("robot2> Received:", repr(data2))
    #dashbord
    poweron="power on\n"
   ...
   #script 
    ...
    initMovej="movej([-1.0262544790851038, -1.1924670378314417, 2.0154342651367188, -0.8343752066241663, -1.0188658873187464, -0.019378010426656544], a=1.3962634015954636, v=1.0471975511965976)\n"
    a=-0.50
    ...
    RG2="RG2(0)\n"
    time.sleep(1)
    robot2.send (initMovej.encode("utf-8"))
    data = robot2.recv(1024)
    print ("robot> Received:", repr(data))
